...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/todayFunding.css">
<meta charset="UTF-8">
<title>오늘의 상점</title>
...
<body>
	<div class="container">
		<h1>
			<img
				src="${pageContext.request.contextPath}/resources/images/icons/famicons_today-outline.svg"
				alt="오늘의 펀딩" class="icon" />
			<c:out value="${userDTO.nickname}" />
			사장님의 <span class="highlight">오늘의 상점</span> -
			<c:out value="${storeDTO.storeName}" />
		</h1>

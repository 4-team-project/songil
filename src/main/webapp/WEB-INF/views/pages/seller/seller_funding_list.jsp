...
<c:forEach var="funding" items="${funding}" varStatus="status">
    <c:set var="current" value="${funding.currentQty != null ? funding.currentQty : 0}" />
    ...
    <div class="funding-card" onclick="location.href='/seller/store/stats?fundingId=${funding.fundingId}'">
